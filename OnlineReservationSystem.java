...
class Ticket{
    ...
    Ticket(String name,int age,String boarding,String deboardingPoint,String classtype, String date,String trainName,int pnr){
        this.name = name ;
        this.age = age ;
...
public class OnlineReservationSystem {
    ...
    private static void bookTicket() {
        ...
        Ticket ticket = new Ticket(name, age, boarding, deboardingPoint, classtype, date, trainName, pnr);
        bookedTickets.add(ticket);

        System.out.println("\nYour ticket is booked ");
        System.out.println(boarding+" TO "+deboardingPoint);
    ...
    private static void cancelTicket() {
        ...
        if (ticket != null) {
            ...
            System.out.println("----"+ticket.getboarding()+" TO "+ticket.getdeboardingPoint()+"----");
            System.out.println("ClassType: "+ticket.getclasstype());
