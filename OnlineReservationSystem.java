...
class Ticket{
    ...
    Ticket(String name,int age,String boarding,String deboardingPoint,String date,String trainName,int pnr){
        this.name = name ;
        this.age = age ;
...
public class OnlineReservationSystem {
    ...
    private static void bookTicket() {
        ...
        Ticket ticket = new Ticket(name, age, boarding, deboardingPoint, date, trainName, pnr);
